...
$header_class = array('ht-site-header', 'ht-header-five', $viral_express_mh_menu_hover_style, $viral_express_tagline_position, $viral_express_mh_border);
...
<header id="ht-masthead" class="<?php echo esc_attr(implode(' ', $header_class)); ?>" <?php echo viral_express_get_schema_attribute('header'); ?>>
    ...
    <div class="ht-middle-header">
        <div class="ht-container">
            ...
            <?php if (is_active_sidebar('viral-express-header-widget')) { ?>
                <div class="ht-header-widget">
                    <?php dynamic_sidebar('viral-express-header-widget'); ?>
                </div>
            <?php } ?>
        </div>
    </div>
