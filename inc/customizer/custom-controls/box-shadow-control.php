...
/** Color Tab Control */
class Viral_Express_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'viral-express'),
            'x' => esc_attr__('X', 'viral-express'),
            'y' => esc_attr__('Y', 'viral-express'),
            'blur' => esc_attr__('Blur', 'viral-express'),
            'spread' => esc_attr__('Spread', 'viral-express'),
            'inset' => esc_attr__('Inset', 'viral-express'),
            'color' => esc_attr__('Color', 'viral-express'),
        );
        if (false === $id) {
