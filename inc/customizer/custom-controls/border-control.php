...
/** Border Control */
class Viral_Express_Border_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'border_width' => esc_attr__('Width', 'viral-express'),
            'border_type' => esc_attr__('Border Type', 'viral-express'),
            'color' => esc_attr__('Border Color', 'viral-express'),
            'top' => esc_attr__('Top', 'viral-express'),
            'right' => esc_attr__('Right', 'viral-express'),
            'bottom' => esc_attr__('Bottom', 'viral-express'),
            'left' => esc_attr__('Left', 'viral-express')
        );
        if (false === $id) {
    ...
    function get_all_border_types() {
        return array(
            '' => esc_attr__('None', 'viral-express'),
            'solid' => esc_attr__('Solid', 'viral-express'),
            'double' => esc_attr__('Double', 'viral-express'),
            'dotted' => esc_attr__('Dotted', 'viral-express'),
            'dashed' => esc_attr__('Dashed', 'viral-express'),
            'groove' => esc_attr__('Groove', 'viral-express')
        );
    }
