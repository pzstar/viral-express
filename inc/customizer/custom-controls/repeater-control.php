...
/** Repeater Control */
class Viral_Express_Repeater_Control extends WP_Customize_Control {
                    ...
                    <div class="ht--repeater-fields">
                            ...
                            <div class="ht--fields ht--type-<?php echo esc_attr($field['type']) . ' ' . esc_attr($class); ?>">
                                ...
                                switch ($field['type']) {
                                    ...
                                    case 'category':
                                        ...
                                        echo viral_express_get_dropdown_indent(0, $all_categories, array($this->value()), $cat_ids);
                                        echo '</select>';
                                        break;
                                    ...
                                    case 'taxonomycheckbox':
                                        ...
                                        $args = array(
                                            'selected_cats' => $new_value_array,
                                            'taxonomy' => $taxonomy,
                                            'show_count' => true
                                        );
                                        viral_express_terms_checklist(0, $args);
                                        echo '</ul>';
                                        echo '<input data-default="' . esc_attr($default) . '" type="hidden" value="' . esc_attr(implode(',', $new_value_array)) . '" data-name="' . esc_attr($key) . '"/>';
                                        break;
                        ...
                        <div class="ht--clearfix ht--repeater-footer">
                            <div class="alignright">
                                <a class="ht--repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'viral-express') ?></a> |
                                <a class="ht--repeater-field-close" href="#close"><?php esc_html_e('Close', 'viral-express') ?></a>
                            </div>
                        </div>
                    </div>
                </li>
