...
/** Background Control */
class Viral_Express_Background_Image_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->button_labels = apply_filters('viral_express_customizer_background_button_labels', $button_labels, $id);

        // Set field labels
        $field_labels = $this->get_field_labels();
        $this->field_labels = apply_filters('viral_express_customizer_background_field_labels', $field_labels, $id);

        // Set background choices
        $background_choices = $this->get_background_choices();
        $this->background_choices = apply_filters('viral_express_customizer_background_choices', $background_choices, $id);
    }
    ...
    public static function get_button_labels() {
        ...
        $button_labels = array(
            'select' => esc_html__('Select Image', 'viral-express'),
            'remove' => esc_html__('Remove', 'viral-express'),
        );
    ...
    public static function get_field_labels() {
        ...
        $field_labels = array(
            'repeat' => esc_html__('Repeat', 'viral-express'),
            'size' => esc_html__('Size', 'viral-express'),
            'position' => esc_html__('Position', 'viral-express'),
            'attachment' => esc_html__('Attachment', 'viral-express'),
            'color' => esc_html__('Background Color', 'viral-express'),
            'overlay' => esc_html__('Overlay Color', 'viral-express')
        );
    ...
    public static function get_background_choices() {
        ...
        $choices = array(
            'repeat' => array(
                'no-repeat' => esc_html__('No Repeat', 'viral-express'),
                'repeat' => esc_html__('Tile', 'viral-express'),
                'repeat-x' => esc_html__('Tile Horizontally', 'viral-express'),
                'repeat-y' => esc_html__('Tile Vertically', 'viral-express')
            ),
            'size' => array(
                'auto' => esc_html__('Default', 'viral-express'),
                'cover' => esc_html__('Cover', 'viral-express'),
                'contain' => esc_html__('Contain', 'viral-express')
            ),
            'position' => array(
                'left-top' => esc_html__('Left Top', 'viral-express'),
                'left-center' => esc_html__('Left Center', 'viral-express'),
                'left-bottom' => esc_html__('Left Bottom', 'viral-express'),
                'right-top' => esc_html__('Right Top', 'viral-express'),
                'right-center' => esc_html__('Right Center', 'viral-express'),
                'right-bottom' => esc_html__('Right Bottom', 'viral-express'),
                'center-top' => esc_html__('Center Top', 'viral-express'),
                'center-center' => esc_html__('Center Center', 'viral-express'),
                'center-bottom' => esc_html__('Center Bottom', 'viral-express')
            ),
            'attachment' => array(
                'fixed' => esc_html__('Fixed', 'viral-express'),
                'scroll' => esc_html__('Scroll', 'viral-express')
            )
        );
