 ...
 */
function viral_express_frontpage_slider1_section() {
    $disable_section = get_theme_mod('viral_express_frontpage_slider1_section_disable', 'off');
    $overwrite = get_theme_mod('viral_express_slider1_overwrite_block_title_color', false);
    ...
    <section id="ht-slider1-section" class="ht-section ht-slider1-section <?php echo esc_attr($class); ?>">
        <div class="ht-section-wrap">
            <div class="ht-container ht-slider1-container">
                <?php viral_express_frontpage_slider1_content(); ?>
            </div>
        </div>
    </section>
    <?php
...
function viral_express_frontpage_slider1_content() {

    $slider_blocks = get_theme_mod('viral_express_frontpage_slider1_blocks', json_encode(array(
        array(
            'title' => '',
            'category' => '',
            'layout' => 'style1',
    ...
    if ($slider_blocks) {
        ...
        foreach ($slider_blocks as $slider_block) {
            if ($slider_block->enable == 'on') {
                ...
                do_action('viral_express_slider1_section', $args);
            }
        }
    }
