 ...
 */
add_action('widgets_init', 'viral_express_register_contact_info');

function viral_express_register_contact_info() {
    register_widget('viral_express_contact_info');
}

class viral_express_contact_info extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'viral_express_contact_info', '&bull; Viral Express : Contact Info', array(
                'description' => esc_html__('A widget to display Contact Information', 'viral-express')
            )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'phone' => array(
                'viral_express_widgets_name' => 'phone',
                'viral_express_widgets_title' => esc_html__('Phone', 'viral-express'),
                'viral_express_widgets_field_type' => 'text'
            ),
            'contact_info_email' => array(
                'viral_express_widgets_name' => 'email',
                'viral_express_widgets_title' => esc_html__('Email', 'viral-express'),
                'viral_express_widgets_field_type' => 'text'
            ),
            'website' => array(
                'viral_express_widgets_name' => 'website',
                'viral_express_widgets_title' => esc_html__('Website', 'viral-express'),
                'viral_express_widgets_field_type' => 'text'
            ),
            'address' => array(
                'viral_express_widgets_name' => 'address',
                'viral_express_widgets_title' => esc_html__('Contact Address', 'viral-express'),
                'viral_express_widgets_field_type' => 'textarea',
                'viral_express_widgets_row' => '4'
            ),
            'time' => array(
                'viral_express_widgets_name' => 'time',
                'viral_express_widgets_title' => esc_html__('Contact Time', 'viral-express'),
                'viral_express_widgets_field_type' => 'textarea',
                'viral_express_widgets_row' => '3'
            ),
            'input_close' => array(
            ...
            'text_color' => array(
                'viral_express_widgets_name' => 'text_color',
                'viral_express_widgets_title' => esc_html__('Text Color', 'viral-express'),
                'viral_express_widgets_field_type' => 'color'
            ),
            'icon_color' => array(
                'viral_express_widgets_name' => 'icon_color',
                'viral_express_widgets_title' => esc_html__('Icon Color', 'viral-express'),
                'viral_express_widgets_field_type' => 'color'
            ),
            'background_color' => array(
                'viral_express_widgets_name' => 'background_color',
                'viral_express_widgets_title' => esc_html__('Background Color', 'viral-express'),
                'viral_express_widgets_field_type' => 'color'
            ),
            'padding' => array(
                'viral_express_widgets_name' => 'padding',
                'viral_express_widgets_title' => esc_html__('Padding', 'viral-express'),
