...
if (class_exists('WP_Customize_Section')) {
    ...
    /**
     * Class Viral_Express_Toggle_Section
     *
     * @access public
     */
    class Viral_Express_Toggle_Section extends WP_Customize_Section {
        ...
        /**
         * Viral_Express_Toggle_Section constructor.
         *
        ...
        public function enqueue() {
            wp_enqueue_script('ht--toggle-section', VIRAL_EXPRESS_CUSTOMIZER_URL . 'custom-controls/assets/js/toggle-section.js', array('jquery'), VIRAL_EXPRESS_VER, true);
        }
