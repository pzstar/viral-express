 ...
 * @access public
 */
class Viral_Express_Typography_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->l10n = wp_parse_args(
            $this->l10n, array(
                'family' => esc_html__('Font Family', 'viral-express'),
                'style' => esc_html__('Font Weight/Style', 'viral-express'),
                'text_transform' => esc_html__('Text Transform', 'viral-express'),
                'text_decoration' => esc_html__('Text Decoration', 'viral-express'),
                'size' => esc_html__('Font Size', 'viral-express'),
                'line_height' => esc_html__('Line Height', 'viral-express'),
                'letter_spacing' => esc_html__('Letter Spacing', 'viral-express'),
                'color' => esc_html__('Font Color', 'viral-express')
            )
        );
    }
    ...
    public function enqueue() {
        wp_enqueue_script('ht--customize-typograhpy-controls', VIRAL_EXPRESS_CUSTOMIZER_URL . 'custom-controls/typography/js/customize-controls.js', array('jquery'), VIRAL_EXPRESS_VER, true);
        wp_enqueue_style('ht--customize-typograhpy-controls', VIRAL_EXPRESS_CUSTOMIZER_URL . 'custom-controls/typography/css/customize-controls.css', array(), VIRAL_EXPRESS_VER);
    }
        ...
        <ul>
            ...
            <li class="ht--typography-color">
                ...
                <div class="customize-control-content">
                    <input class="ht--color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e('Hex Value', 'viral-express'); ?>" {{{ data.color.link }}} value="{{ data.color.value }}"  />
                </div>
            </li>
            <# } #>
    ...
    public function get_registered_fonts() {
        return viral_express_register_fonts();
    }
    ...
    public function get_fonts() {
        return viral_express_all_fonts();
    }
    ...
    public function get_font_weight_choices() {
        ...
        return array(
            '400' => esc_html__('Normal', 'viral-express'),
            '400italic' => esc_html__('Normal Italic', 'viral-express'),
            '700' => esc_html__('Bold', 'viral-express'),
            '700italic' => esc_html__('Bold Italic', 'viral-express')
        );
    }
    ...
    public function get_text_decoration_choices() {
        return array(
            ...
            'underline' => esc_html__('Underline', 'viral-express'),
            'line-through' => esc_html__('Line-through', 'viral-express'),
            'overline' => esc_html__('Overline', 'viral-express')
        );
    }
    ...
    public function get_text_transform_choices() {
        return array(
            'none' => esc_html__('None', 'viral-express'),
            'uppercase' => esc_html__('Uppercase', 'viral-express'),
            'lowercase' => esc_html__('Lowercase', 'viral-express'),
            'capitalize' => esc_html__('Capitalize', 'viral-express')
        );
    }
