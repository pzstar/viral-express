 ...
 */
function viral_express_frontpage_carousel1_section() {
    $disable_section = get_theme_mod('viral_express_frontpage_carousel1_section_disable', 'off');
    $overwrite = get_theme_mod('viral_express_carousel1_overwrite_block_title_color', false);
    ...
    <section id="ht-carousel1-section" class="ht-section ht-carousel1-section <?php echo esc_attr($class); ?>">
        <div class="ht-section-wrap">
            <div class="ht-container ht-carousel1-container">
                <?php viral_express_frontpage_carousel1_content(); ?>
            </div>
        </div>
    </section>
    <?php
...
function viral_express_frontpage_carousel1_content() {

    $carousel1_blocks = get_theme_mod('viral_express_frontpage_carousel1_blocks', json_encode(array(
        array(
            'title' => '',
            'category' => '',
            'layout' => 'style1',
    ...
    if ($carousel1_blocks) {
        ...
        foreach ($carousel1_blocks as $carousel1_block) {
            if ($carousel1_block->enable == 'on') {
                ...
                do_action('viral_express_carousel1_section', $args);
            }
        }
    }
