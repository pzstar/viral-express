...
/** Dimensions Control */
class Viral_Express_Dimensions_Control extends WP_Customize_Control {
    ...
    public function to_json() {
        ...
        $this->json['title'] = esc_html__('Link values together', 'viral-express');
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'desktop_top' => esc_attr__('Top', 'viral-express'),
            'desktop_right' => esc_attr__('Right', 'viral-express'),
            'desktop_bottom' => esc_attr__('Bottom', 'viral-express'),
            'desktop_left' => esc_attr__('Left', 'viral-express'),
            'tablet_top' => esc_attr__('Top', 'viral-express'),
            'tablet_right' => esc_attr__('Right', 'viral-express'),
            'tablet_bottom' => esc_attr__('Bottom', 'viral-express'),
            'tablet_left' => esc_attr__('Left', 'viral-express'),
            'mobile_top' => esc_attr__('Top', 'viral-express'),
            'mobile_right' => esc_attr__('Right', 'viral-express'),
            'mobile_bottom' => esc_attr__('Bottom', 'viral-express'),
            'mobile_left' => esc_attr__('Left', 'viral-express'),
        );
        if (false === $id) {
