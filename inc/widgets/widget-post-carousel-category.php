 ...
 */
add_action('widgets_init', 'viral_express_register_category_post_carousel');

function viral_express_register_category_post_carousel() {
    register_widget('viral_express_category_post_carousel');
}

class viral_express_category_post_carousel extends WP_Widget {

    public function __construct() {
        $widget_ops = array('description' => esc_html__('A widget to display category post with thumbnail.', 'viral-express'));
        parent::__construct('viral_express_category_post_carousel', '&bull; Viral Express : Post Carousel by Category', $widget_ops);
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'thumbnail_size' => array(
                ...
                'viral_express_widgets_default' => 'viral-express-500x500'
            ),
            'display_date' => array(
    ...
    public function widget($args, $instance) {
        ...
        $thumbnail_size = isset($instance['thumbnail_size']) ? $instance['thumbnail_size'] : 'viral-express-500x500';
